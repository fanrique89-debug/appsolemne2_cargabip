...
# Evitamos autolink de dominios/URLs en iOS
st.text("Fuente: datos[dot]gob[dot]cl · Recurso con DataStore (API CKAN)")
...
if not compat:
    ...
    points_layer = pdk.Layer(
        ...
        get_radius=60,
        pickable=True,
        get_fill_color=[33, 150, 243, 180],  # color fijo
    )
    ...
    deck = pdk.Deck(
        ...
        parameters={"depthTest": False, "antialias": True},
    )
